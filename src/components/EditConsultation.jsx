                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-2 items-start">
                  ...
                  <div className="md:col-span-1">
                    <SelectField
                      ...
                      options={[
                        { value: "ایک دن", label: "ایک دن" },
                        { value: "دو دن", label: "دو دن" },
                        { value: "تین دن", label: "تین دن" },
                        { value: "چار دن", label: "چار دن" },
                        { value: "پانچ دن", label: "پانچ دن" },
                        { value: "چھ دن", label: "چھ دن" },
                        { value: "ایک ہفتہ", label: "ایک ہفتہ" },
                        { value: "آٹھ دن", label: "آٹھ دن" },
                        { value: "نو دن", label: "نو دن" },
                        { value: "دس دن", label: "دس دن" },
                        { value: "گیارہ دن", label: "گیارہ دن" },
                        { value: "بارہ دن", label: "بارہ دن" },
                        { value: "تیرہ دن", label: "تیرہ دن" },
                        { value: "پندرہ دن", label: "پندرہ دن" },
                        { value: "بیس دن", label: "بیس دن" },
                        { value: "پچیس دن", label: "پچیس دن" },
                        { value: "ایک مہینہ", label: "ایک مہینہ" },
                        { value: "دو ہفتے", label: "دو ہفتے" },
                        { value: "تین ہفتے", label: "تین ہفتے" },
                        { value: "چار ہفتے", label: "چار ہفتے" },
                        { value: "چھ ہفتے", label: "چھ ہفتے" },
                        { value: "دس ہفتے", label: "دس ہفتے" },
                        { value: "تین مہینے", label: "تین مہینے" },
                        { value: "نو مہینے", label: "نو مہینے" },
                        { value: "بارہ مہینے", label: "بارہ مہینے" },
                        { value: "ضرورت کے مطابق", label: "ضرورت کے مطابق" },
                        { value: "طویل المدت", label: "طویل المدت" },
                        { value: "مختصر المدت", label: "مختصر المدت" },
                      ]}
                      urdu
                      selectClassName="px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 text-lg direction-rtl hover:border-gray-300 transition-colors"
                    />
